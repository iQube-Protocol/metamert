...
export type Database = {
  ...
  public: {
    Tables: {
      access_grants: {
        Row: {
          ...
          allowed_experiments: string[] | null
      ...
      access_invitations: {
        Row: {
          ...
          issuer_persona_id: string | null
          label: string | null
          max_uses: number
          open_peer_channel: boolean
          revoked_at: string | null
          role: string
          status: string
          uses: number
      ...
      agent_gateway_sessions: {
        Row: {
          ...
          cartridge_flags: Json | null
          client_id: string | null
          code_expires_at: string | null
          consent_record: Json | null
          ...
          passport_status: Json | null
          pkce_challenge: string | null
          principal_public_ref: string | null
          redirect_uri: string | null
          requested_scope: string[]
          revoked_at: string | null
          service_agreements: Json
          session_kind: string
          status: string
          subject_pairwise_ref: string | null
      ...
      canonical_plate_registry: {
        Row: {
          assets: Json
          composed_by_commitment: string
          ...
          id: string
          kind: string
          knowledge_qube_ref: string | null
          machine_tags: string[]
          message: string
          published_at: string | null
          ratified_at: string | null
      ...
      capability_registry: {
        Row: {
          ...
          id: string
          last_operational_receipt_id: string | null
          lifecycle_state: string
          object: Json
          operational_validations: number
          registered_receipt_id: string | null
          standing: number
          standing_band: string
          updated_at: string
        }
        Insert: {
          capability_id: string
      ...
      companion_captured_objects: {
        ...
        Relationships: [
          {
            foreignKeyName: "companion_captured_objects_persona_id_fkey"
            columns: ["persona_id"]
            isOneToOne: false
      ...
      companion_observation_latest: {
        ...
        Relationships: [
          {
            foreignKeyName: "companion_observation_latest_persona_id_fkey"
            columns: ["persona_id"]
            isOneToOne: true
            referencedRelation: "personas"
            referencedColumns: ["id"]
      ...
      companion_observer_grants: {
        ...
        Relationships: [
          {
            foreignKeyName: "companion_observer_grants_persona_id_fkey"
            columns: ["persona_id"]
            isOneToOne: false
            referencedRelation: "personas"
            referencedColumns: ["id"]
      ...
      companion_standing_snapshots: {
        ...
        Relationships: [
          {
            foreignKeyName: "companion_standing_snapshots_persona_id_fkey"
            columns: ["persona_id"]
            isOneToOne: true
            referencedRelation: "personas"
            referencedColumns: ["id"]
      ...
      constitutional_agreements: {
        Row: {
          acceptance: Json | null
          agreement_id: string
          authorized_receipt_id: string | null
          capability_ref: string | null
          created_at: string
          display_label: string
          formed_receipt_id: string | null
          id: string
          object: Json
          owner_commitment: string
          selected_agent_ref: string | null
          status: string
          updated_at: string
        }
        Insert: {
      ...
      corpus_candidate_sources: {
        Row: {
          ...
          campaign_sub_domain: string | null
          ...
          resolution_chain: Json
          retrieved_at: string | null
          review_workflow_status: string
          source_id: string
          structural_tags: Json
          title: string
          updated_at: string
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "corpus_candidate_sources_duplicate_of_source_id_fkey"
            columns: ["duplicate_of_source_id"]
            isOneToOne: false
            referencedRelation: "corpus_candidate_sources"
            referencedColumns: ["source_id"]
          },
          {
            foreignKeyName: "corpus_candidate_sources_evidence_row_id_fkey"
            columns: ["evidence_row_id"]
            isOneToOne: false
      ...
      corpus_coverage_pillars: {
        Row: {
          ...
          saturation_confirmed_at: string | null
          saturation_confirmed_by: string | null
          status: string
          updated_at: string
        }
        Insert: {
      ...
      delegation_agentkit_attestations: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "delegation_agentkit_attestations_grant_fk"
      ...
      discovery_candidates: {
        Row: {
          ...
          evidence_ids: string[]
          id: string
          promoted_invariant_id: string | null
      ...
      domain_profile_presentation_events: {
        Row: {
          applied_presentation_threshold: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "domain_profile_presentation_events_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "domain_profiles"
            referencedColumns: ["id"]
          },
        ]
      }
      domain_profiles: {
        ...
        Relationships: [
          {
            foreignKeyName: "domain_profiles_source_candidate_id_fkey"
      ...
      experiment_results: {
        Row: {
          ...
          receipt_id: string | null
          results_json: string
          submitted_by_persona_id: string | null
          visibility: string
        }
        Insert: {
          aggregates?: Json
      ...
      governance_ratifications: {
        Row: {
          ...
          anchoring_is_retrospective: boolean
          ...
          historical_content_recoverable: boolean | null
          id: string
          object: Json
          previous_content_hash: string | null
          published_at: string | null
          ratification_kind: string
          ratified_at: string
          ratified_by_ref: string
          receipt_id: string | null
          recorded_at: string
          summary: string
          supersedes: string[]
      ...
      horizen_pulse_correlation_traces: {
        Row: {
          ...
          created_at: string
          issued_at: string | null
          local_contract_error: string | null
          normalized_submission: Json | null
          raw_submit_response: Json | null
          reached_partner_submission: boolean
          selected_message_hash: string | null
          selected_message_length: number | null
          selected_message_source: string | null
          signature_ref: string | null
          status_reads: Json
          status_reread_arguments: Json | null
          submit_arguments: Json | null
          timestamps: Json
      ...
      invariant_collection_members: {
        ...
        Relationships: [
          {
            foreignKeyName: "invariant_collection_members_collection_id_fkey"
            columns: ["collection_id"]
            isOneToOne: false
            referencedRelation: "invariant_collections"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "invariant_collection_members_invariant_id_fkey"
            columns: ["invariant_id"]
            isOneToOne: false
            referencedRelation: "invariants"
            referencedColumns: ["id"]
      ...
      invariant_collections: {
        Row: {
          created_at: string
          curator_alias_commitment: string | null
          curator_persona_id: string | null
          description: string | null
          id: string
          name: string
      ...
      invariant_contexts: {
        ...
        Relationships: [
          {
            foreignKeyName: "invariant_contexts_invariant_id_fkey"
            columns: ["invariant_id"]
            isOneToOne: false
            referencedRelation: "invariants"
            referencedColumns: ["id"]
      ...
      invariant_edges: {
        Row: {
          ...
          dvn_receipt_id: string | null
          edge_type: string
          from_invariant_id: string
          id: string
          provenance: Json
          rationale: string | null
          reasoning_provenance: Json
          to_invariant_id: string
          weight: number
        }
        Insert: {
          context_id?: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "invariant_edges_context_id_fkey"
            columns: ["context_id"]
            isOneToOne: false
            referencedRelation: "invariant_contexts"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "invariant_edges_from_invariant_id_fkey"
            columns: ["from_invariant_id"]
            isOneToOne: false
            referencedRelation: "invariants"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "invariant_edges_to_invariant_id_fkey"
            columns: ["to_invariant_id"]
            isOneToOne: false
            referencedRelation: "invariants"
            referencedColumns: ["id"]
          },
      ...
      invariant_node_flips: {
        Row: {
          authoritative: boolean
          flipped_at: string
          flipped_by_persona: string | null
          node_id: string
          rationale: string | null
        }
        Insert: {
      ...
      invariant_qubes: {
        Row: {
          ...
          created_at: string
          creator_alias_commitment: string | null
          creator_persona_id: string | null
          dvn_receipt_id: string | null
          id: string
          iqube_id: string | null
          manifest: Json
        ...
        Relationships: [
          {
            foreignKeyName: "invariant_qubes_collection_id_fkey"
            columns: ["collection_id"]
            isOneToOne: false
            referencedRelation: "invariant_collections"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "invariant_qubes_supersedes_id_fkey"
            columns: ["supersedes_id"]
            isOneToOne: false
            referencedRelation: "invariant_qubes"
            referencedColumns: ["id"]
          },
        ]
      }
      invariant_shadow_observations: {
        Row: {
          cited_ids: string[]
          id: string
      ...
      invariants: {
        Row: {
          ...
          provenance: Json
          ratified_source: string | null
          reach: number
          reasoning_provenance: Json
          seed_id: string | null
          semantic_type: string | null
          standing: number
          standing_ref: Json | null
          statement: string
          status: string
          supersedes_id: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "invariants_ontology_class_id_fkey"
            columns: ["ontology_class_id"]
            isOneToOne: false
            referencedRelation: "ontology_classes"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "invariants_supersedes_id_fkey"
            columns: ["supersedes_id"]
            isOneToOne: false
            referencedRelation: "invariants"
            referencedColumns: ["id"]
      ...
      linked_external_wallets: {
        Row: {
          ...
          created_at: string
          id: string
          may_sign_principal_mandate: boolean
          originating_write_path: string
          proof_ref: string | null
      ...
      ontology_classes: {
        ...
        Relationships: [
          {
            foreignKeyName: "ontology_classes_parent_id_fkey"
            columns: ["parent_id"]
            isOneToOne: false
            referencedRelation: "ontology_classes"
            referencedColumns: ["id"]
      ...
      partner_authorization_requests: {
        Row: {
          agent_id: string | null
      ...
      passport_citizen_privileges: {
        Row: {
          ...
          steward_role_updated_at: string | null
          updated_at: string
        }
        Insert: {
          active_restrictions?: Json
      ...
      passport_connection_challenges: {
        Row: {
          audience: string
          ...
          nonce_hash: string
          origin: string
          provisional_connection_id: string
      ...
      passport_peer_channels: {
        Row: {
          ...
          principal_a_label: string | null
          principal_a_ref: string
          principal_b_label: string | null
          principal_b_ref: string
          status: string
        }
        Insert: {
          created_at?: string
      ...
      passport_peer_messages: {
        ...
        Relationships: [
          {
            foreignKeyName: "passport_peer_messages_channel_id_fkey"
            columns: ["channel_id"]
            isOneToOne: false
      ...
      passport_peer_shared_artifacts: {
        Row: {
          artifact_id: string
          artifact_type: string
          channel_id: string
          copied_to_locker_at: string | null
          created_at: string
          id: string
        ...
        Relationships: [
          {
            foreignKeyName: "passport_peer_shared_artifacts_channel_id_fkey"
            columns: ["channel_id"]
            isOneToOne: false
            referencedRelation: "passport_peer_channels"
            referencedColumns: ["id"]
      ...
      passport_pending_auth: {
        Row: {
          ...
          kybe_identity_id: string
          origin: string
          persona_activation_consumed_at: string | null
          persona_activation_handoff_consumed_at: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "passport_pending_auth_kybe_identity_id_fkey"
            columns: ["kybe_identity_id"]
            isOneToOne: false
            referencedRelation: "kybe_identity"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "passport_pending_auth_root_identity_id_fkey"
      ...
      persona_agent_assignments: {
        ...
        Relationships: [
          {
            foreignKeyName: "persona_agent_assignments_agent_root_id_fkey"
            columns: ["agent_root_id"]
            isOneToOne: false
            referencedRelation: "agent_root_identity"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "persona_agent_assignments_persona_id_fkey"
            columns: ["persona_id"]
            isOneToOne: false
            referencedRelation: "personas"
            referencedColumns: ["id"]
      ...
      reasoning_trajectories: {
        Row: {
          activated_seed_ids: string[]
          cartridge_id: string
          created_at: string
          discarded_seed_ids: string[]
          id: string
      ...
      research_candidate_experiments: {
        Row: {
          charter_ref: string | null
          created_at: string
          depends_on: string[]
          family: string | null
          governing_invariants: string[]
          hypothesis: string
          id: string
          layer: string | null
          review_history: Json
      ...
      reviewer_agreement_authorizations: {
        Row: {
    ...
    Functions: {
      ...
      venture_receipt_action_type_constraint: { Args: never; Returns: string[] }
    }
    Enums: {
      codex_asset_kind:
        | "character_poster"
