...
const DEFAULT_SHELL_CONFIG = {
  ...
  menu: {
    ...
    policy: {
      ...
      quick_links: [
        { id: "ql-explore", label: "Explore", icon: "compass", action: "explore" },
        { id: "ql-wallet", label: "Wallet", icon: "wallet", action: "wallet" },
        { id: "ql-rewards", label: "Rewards", icon: "gift", action: "rewards" },
        { id: "ql-quests", label: "Quests", icon: "map", action: "quests" },
        { id: "ql-library", label: "Library", icon: "library", action: "library" },
        { id: "ql-settings", label: "Settings", icon: "settings", action: "settings" },
        { id: "ql-help", label: "Help", icon: "help-circle", action: "help" },
